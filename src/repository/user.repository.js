...
async function deleteUserByIdDB(users_infoId) {
  const client = await pool.connect();
...
module.exports = { createUserDB, getAllUsersDB, updateUsersByIdDB, deleteUserByIdDB, getUserByIdDB };
